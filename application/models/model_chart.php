...
class Model_chart extends CI_Model {
	...
	public function listnilai($param,$data){
		$tahun=$data['tahun'];
		//Query mencari record berdasarkan ID
		$hasil = $this->db->query("SELECT a.target,a.name,AVG(a.rata) as rata FROM (SELECT a.target,b.name,sum(a.rata) as rata FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE unit ='$param' and tahun=$tahun GROUP BY target,tahun,periode)a GROUP by a.target order by rata DESC LIMIT 10");
		if($hasil->num_rows() > 0){
			return $hasil->result();
		} else{
			return array();
	...
	public function listnilaip1($param,$data){
		$tahun=$data['tahun'];
		//Query mencari record berdasarkan ID
		$hasil = $this->db->query("SELECT a.target,a.name,AVG(a.rata) as rata FROM (SELECT a.target,b.name,sum(a.rata) as rata FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE unit ='$param' and tahun=$tahun and periode=1 GROUP BY target,tahun,periode)a GROUP by a.target order by rata DESC LIMIT 10");
		if($hasil->num_rows() > 0){
			return $hasil->result();
		} else{
			return array();
	...
	public function listnilaip2($param,$data){
		$tahun=$data['tahun'];
		//Query mencari record berdasarkan ID
		$hasil = $this->db->query("SELECT a.target,a.name,AVG(a.rata) as rata FROM (SELECT a.target,b.name,sum(a.rata) as rata FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE unit ='$param' and tahun=$tahun and periode=2 GROUP BY target,tahun,periode)a GROUP by a.target order by rata DESC LIMIT 10");
		if($hasil->num_rows() > 0){
			return $hasil->result();
		} else{
			return array();
	...
	public function listnilaip3($param,$data){
		$tahun=$data['tahun'];
		//Query mencari record berdasarkan ID
		$hasil = $this->db->query("SELECT a.target,a.name,AVG(a.rata) as rata FROM (SELECT a.target,b.name,sum(a.rata) as rata FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE unit ='$param' and tahun=$tahun and periode=3 GROUP BY target,tahun,periode)a GROUP by a.target order by rata DESC LIMIT 10");
		if($hasil->num_rows() > 0){
			return $hasil->result();
		} else{
			return array();
	...
	public function listnilaip4($param,$data){
		$tahun=$data['tahun'];
		//Query mencari record berdasarkan ID
		$hasil = $this->db->query("SELECT a.target,a.name,AVG(a.rata) as rata FROM (SELECT a.target,b.name,sum(a.rata) as rata FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE unit ='$param' and tahun=$tahun and periode=4 GROUP BY target,tahun,periode)a GROUP by a.target order by rata DESC LIMIT 10");
		if($hasil->num_rows() > 0){
			return $hasil->result();
		} else{
			return array();
...
SELECT 'D' as kategori, COUNT(*) as nilai FROM (SELECT a.target,a.name,a.tahun,AVG(a.rata) as rata from (SELECT a.target,b.name,a.tahun,a.periode,sum(a.rata) as rata FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE unit ='$param' AND tahun='$tahun' AND periode=4 GROUP BY target,tahun,periode) a group by target) a WHERE rata < 50)a");
	...
	public function nilai_dimensi1($param,$data){
		$tahun=$data['tahun'];
		//Query mencari record berdasarkan ID
		$hasil = $this->db->query("select b.id_rekomendasi,a.rata,a.Dimensi,b.top,b.bottom from (SELECT 'Collaborate' as Dimensi, avg(hasilq1) as rata,1 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun UNION
			SELECT 'Empower Diversity' as Dimensi, avg(hasilq2) as rata,2 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun UNION
			SELECT 'Honesty' as Dimensi, avg(hasilq3) as rata,3 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun UNION
			SELECT 'Commitment' as Dimensi, avg(hasilq4) as rata,4 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun UNION
			SELECT 'Care & Polite' as Dimensi, avg(hasilq5) as rata,5 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun UNION
			...
			SELECT 'Persistent' as Dimensi, avg(hasilq8) as rata,8 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun UNION
			SELECT 'Compliance' as Dimensi, avg(hasilq9) as rata,9 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun UNION
			SELECT 'Risk Management' as Dimensi, avg(hasilq10) as rata,10 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun) a JOIN rekomendasi b on a.id=b.id_rekomendasi ORDER BY rata DESC");
		if($hasil->num_rows() > 0){
			return $hasil->result();
		} else{
			return array();
	...
	public function nilai_dimensip1($param,$data){
		$tahun=$data['tahun'];
		//Query mencari record berdasarkan ID
		$hasil = $this->db->query("select b.id_rekomendasi,a.rata,a.Dimensi,b.top,b.bottom from (SELECT 'Collaborate' as Dimensi, avg(hasilq1) as rata,1 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=1 UNION
			SELECT 'Empower Diversity' as Dimensi, avg(hasilq2) as rata,2 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=1 UNION
			SELECT 'Honesty' as Dimensi, avg(hasilq3) as rata,3 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=1 UNION
			SELECT 'Commitment' as Dimensi, avg(hasilq4) as rata,4 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=1 UNION
			SELECT 'Care & Polite' as Dimensi, avg(hasilq5) as rata,5 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=1 UNION
			SELECT 'Fast & Easy' as Dimensi, avg(hasilq6) as rata,6 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=1 UNION
			SELECT 'Adaptive & Creative' as Dimensi, avg(hasilq7) as rata,7 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=1 UNION
			SELECT 'Persistent' as Dimensi, avg(hasilq8) as rata,8 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun AND periode=1 UNION
			SELECT 'Compliance' as Dimensi, avg(hasilq9) as rata,9 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=1 UNION
			SELECT 'Risk Management' as Dimensi, avg(hasilq10) as rata,10 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=1) a JOIN rekomendasi b on a.id=b.id_rekomendasi ORDER BY rata DESC");
		if($hasil->num_rows() > 0){
			return $hasil->result();
		} else{
			return array();
	...
	public function nilai_dimensip2($param,$data){
		$tahun=$data['tahun'];
		//Query mencari record berdasarkan ID
		$hasil = $this->db->query("select b.id_rekomendasi,a.rata,a.Dimensi,b.top,b.bottom from (SELECT 'Collaborate' as Dimensi, avg(hasilq1) as rata,1 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=2 UNION
			SELECT 'Empower Diversity' as Dimensi, avg(hasilq2) as rata,2 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=2 UNION
			SELECT 'Honesty' as Dimensi, avg(hasilq3) as rata,3 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=2 UNION
			SELECT 'Commitment' as Dimensi, avg(hasilq4) as rata,4 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=2 UNION
			SELECT 'Care & Polite' as Dimensi, avg(hasilq5) as rata,5 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=2 UNION
			SELECT 'Fast & Easy' as Dimensi, avg(hasilq6) as rata,6 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=2 UNION
			SELECT 'Adaptive & Creative' as Dimensi, avg(hasilq7) as rata,7 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=2 UNION
			SELECT 'Persistent' as Dimensi, avg(hasilq8) as rata,8 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun AND periode=2 UNION
			SELECT 'Compliance' as Dimensi, avg(hasilq9) as rata,9 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=2 UNION
			SELECT 'Risk Management' as Dimensi, avg(hasilq10) as rata,10 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=2) a JOIN rekomendasi b on a.id=b.id_rekomendasi ORDER BY rata DESC");
		if($hasil->num_rows() > 0){
			return $hasil->result();
		} else{
			return array();
	...
	public function nilai_dimensip3($param,$data){
		$tahun=$data['tahun'];
		//Query mencari record berdasarkan ID
		$hasil = $this->db->query("select b.id_rekomendasi,a.rata,a.Dimensi,b.top,b.bottom from (SELECT 'Collaborate' as Dimensi, avg(hasilq1) as rata,1 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=3 UNION
			SELECT 'Empower Diversity' as Dimensi, avg(hasilq2) as rata,2 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=3 UNION
			SELECT 'Honesty' as Dimensi, avg(hasilq3) as rata,3 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=3 UNION
			SELECT 'Commitment' as Dimensi, avg(hasilq4) as rata,4 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=3 UNION
			SELECT 'Care & Polite' as Dimensi, avg(hasilq5) as rata,5 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=3 UNION
			SELECT 'Fast & Easy' as Dimensi, avg(hasilq6) as rata,6 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=3 UNION
			SELECT 'Adaptive & Creative' as Dimensi, avg(hasilq7) as rata,7 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=3 UNION
			SELECT 'Persistent' as Dimensi, avg(hasilq8) as rata,8 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun AND periode=3 UNION
			SELECT 'Compliance' as Dimensi, avg(hasilq9) as rata,9 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=3 UNION
			SELECT 'Risk Management' as Dimensi, avg(hasilq10) as rata,10 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=3) a JOIN rekomendasi b on a.id=b.id_rekomendasi ORDER BY rata DESC");
		if($hasil->num_rows() > 0){
			return $hasil->result();
		} else{
			return array();
	...
	public function nilai_dimensip4($param,$data){
		$tahun=$data['tahun'];
		//Query mencari record berdasarkan ID
		$hasil = $this->db->query("select b.id_rekomendasi,a.rata,a.Dimensi,b.top,b.bottom from (SELECT 'Collaborate' as Dimensi, avg(hasilq1) as rata,1 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=4 UNION
			SELECT 'Empower Diversity' as Dimensi, avg(hasilq2) as rata,2 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=4 UNION
			SELECT 'Honesty' as Dimensi, avg(hasilq3) as rata,3 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=4 UNION
			SELECT 'Commitment' as Dimensi, avg(hasilq4) as rata,4 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=4 UNION
			SELECT 'Care & Polite' as Dimensi, avg(hasilq5) as rata,5 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=4 UNION
			SELECT 'Fast & Easy' as Dimensi, avg(hasilq6) as rata,6 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=4 UNION
			SELECT 'Adaptive & Creative' as Dimensi, avg(hasilq7) as rata,7 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=4 UNION
			SELECT 'Persistent' as Dimensi, avg(hasilq8) as rata,8 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun AND periode=4 UNION
			SELECT 'Compliance' as Dimensi, avg(hasilq9) as rata,9 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=4 UNION
			SELECT 'Risk Management' as Dimensi, avg(hasilq10) as rata,10 id FROM assessment a JOIN tb_pegawai b ON a.target=b.NIP WHERE b.unit='$param' and tahun=$tahun and periode=4) a JOIN rekomendasi b on a.id=b.id_rekomendasi ORDER BY rata DESC");
		if($hasil->num_rows() > 0){
			return $hasil->result();
		} else{
			return array();
